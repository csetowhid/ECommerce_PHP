...
mysqli_query($con,"insert into `order`(user_id,address,city,pincode,payment_type,total_price,payment_status,order_status,coupon_id,coupon_value,coupon_code,added_on) values('$user_id', '$address','$city','$pincode','$payment_type','$total_price','$payment_status','$order_status','$coupon_id','$coupon_value','$coupon_code','$added_on')");
