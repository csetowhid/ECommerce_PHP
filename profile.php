        ...
        <span class="field_error" id="name_error"></span>
                ...
                <div class="col-md-6">
                        <div class="contact-form-wrap mt--60">
                            ...
                            <div class="col-xs-12">
                    <form method="post" id="frmpPassword">
                                    <div class="single-contact-form">
                                        <div class="contact-box name">
...
<input type="password" name="confirm_new_password" id="confirm_new_password" placeholder="Confirm New Password*" style="width:100%">
    ...
    <script>
        ...
        function update_password() {
            ...
            if(new_password=='') {
            jQuery('#new_password_error').html('Please Enter Current Password');
            is_error='yes';
            }
            if(confirm_new_password=='') {
            jQuery('#confirm_new_password_error').html('Please Enter Current Password');
            is_error='yes';
            }
